...
public class Katalog_Beras extends javax.swing.JFrame {

    public Katalog_Beras() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Katalog_Beras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Katalog_Beras().setVisible(true);
            }
        });
    }
